...
public class Barra extends Base {
     ...
     * <code>Base</code>.
     *
     * @param posX es la <code>posiscion en x</code> del objeto Barra.
     * @param posY es el <code>posiscion en y</code> del objeto Barra.
     * @param anima es la <code>animacion</code> del objeto Barra.
     */
    public Barra(int posX, int posY, Animacion anima) {
        super(posX, posY, anima);
    }

    /**
     * Metodo <I>getStr1</I> sobrescrito de la clase <code>Barra</code>.<P>
    ...
    /**
     * Metodo <I>init</I> sobrescrito de la clase <code>Barra</code>.<P>
